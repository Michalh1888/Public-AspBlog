...
{   
    [Authorize(Roles = UserRoles.Admin)]//authorizace třídy(nebo jen akcí) s možností definice rolí(vlast."Roles",více rolí oddělit čárkou)
    public class ArticlesController : Controller
    {
        ...
        {
            _context = context;//Dependency Injection vytvoří instanci db "_context" 
        }

        // GET: Articles
        [AllowAnonymous]//zpřístupnění nepřihlášeným uživatelům
